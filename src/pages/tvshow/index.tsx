          ...
          <Grid.Row>
            ...
            <Grid.Column width={10}>
              <List>
                ...
                <List.Item>
                  <List.Header>Total Number of Episodes: </List.Header>
                ...
                <List.Item>
                  ...
                  <List.Description
                    style={{ height: "200px", oveflow: "scroll" }}
                  >
                    <Accordion
                ...
                <List.Item>
                  <List.Header>Run Time Per Episode: </List.Header>
                ...
                <List.Item>
                  <List.Header>First Episode Air Date: </List.Header>
                  {data.first_air_date}
                </List.Item>
                <List.Item>
                ...
                <List.Item>
                  <List.Header>Ratings: </List.Header>
